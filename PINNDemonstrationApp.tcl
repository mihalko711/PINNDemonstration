...
#  Dec 24, 2024 03:02:36 AM +03  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top2 {base} {
    ...
    text "$site_3_0.tex53" \
        ...
        -font "-family {Libertinus Serif} -size 12" -foreground black \
        -height 4 -highlightbackground #d9d9d9 \
...
proc vTclWindow.top3 {base} {
    ...
    wm focusmodel $top passive
    wm geometry $top 800x600+10+650
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
